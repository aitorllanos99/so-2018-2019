...
ComputerSystem_DebugMessage(121, 's', copyOfExecutingProcessID, processTable[copyOfExecutingProcessID].nombre, selectedProcess, processTable[copyOfExecutingProcessID].nombre); 
