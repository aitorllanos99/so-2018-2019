...
#line 59 "Processor.c"
if ((!Processor_PSW_BitState(INTERRUPT_MASKED_BIT)) && interruptLines_CPU){
...
#line 72 "Processor.c"
ComputerSystem_DebugMessage((Processor_PSW_BitState(EXECUTION_MODE_BIT)?5:4), 'h', Clock_GetTime()); 
#line 74 "Processor.c"
if (MMU_readMemory() == 1){
{ 
#line 78 "Processor.c"
...
ComputerSystem_DebugMessage(130, 'h', operationCode, operand1, operand2, OperatingSystem_GetExecutingProcessID(), registerPC_CPU, registerAccumulator_CPU, registerPSW_CPU, Processor_ShowPSW()); 
