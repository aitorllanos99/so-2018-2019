...
typedef struct {int busy; int initialPhysicalAddress; int processSize; int state; int priority; int copyOfPCRegister; unsigned int copyOfPSWRegister; int programListIndex; char *nombre; int queueID; int copyOfAccumulator; int whenToWakeUp; 
}PCB; 
...
# 12 "OperatingSystem.c" 
void OperatingSystem_PrepareDaemons(); 
#line 13 "OperatingSystem.c"
...
int OperatingSystem_ObtainMainMemory(int , char *, int ); 
...
int OperatingSystem_PartitionLooker(int ); 
#line 35 "OperatingSystem.c"
void OperatingSystem_GiveMemory(int , char *, int ); 
#line 36 "OperatingSystem.c"
void OperatingSystem_FreeMainMemory(); 
...
#line 225 "OperatingSystem.c"
int direccionMem = OperatingSystem_ObtainMainMemory(processSize, (executableProgram->executableName), PID);
...
retValue_acc = direccionMem;
# 2003 "OperatingSystemAspect.c"
return (int )retValue_acc;
 } }
#line 230 "OperatingSystem.c"
loadingPhysicalAddress = partitionsTable[direccionMem].initAddress; 
...
#line 237 "OperatingSystem.c"
int memoryadd = OperatingSystem_LoadProgram(programFile, loadingPhysicalAddress, processSize);
...
retValue_acc = memoryadd;
# 2029 "OperatingSystemAspect.c"
return (int )retValue_acc;
 } }
#line 244 "OperatingSystem.c"
OperatingSystem_GiveMemory(PID, (executableProgram->executableName), direccionMem); 
...
ComputerSystem_DebugMessage(111, 'p', PID, (executableProgram->executableName), statesNames[0]); 
...
int OperatingSystem_ObtainMainMemory(int processSize, char *n, int PID)  
...
ComputerSystem_DebugMessage(142, 'm', PID, n, processSize); 
#line 265 "OperatingSystem.c"

#line 265 "OperatingSystem.c"
int partition = OperatingSystem_PartitionLooker(processSize);
...
if (partitionsTable[i].occupied == 0 && partitionsTable[i].size >= processSize && partitionsTable[i].size < partitionSize){
{ 
...
int OperatingSystem_PartitionLooker(int ps)  
...
if ((partitionsTable[i].size >= topPartition)){
{ 
#line 297 "OperatingSystem.c"
topPartition = partitionsTable[i].size; } }
#line 299 "OperatingSystem.c"
if ((!(partitionsTable[i].size < ps)) && partitionsTable[i].occupied == 0){
numberOfPartitions++; }
...
if ((!(numberOfPartitions < 0 || numberOfPartitions > 0))){
...
void OperatingSystem_GiveMemory(int PID, char *executableName, int selectedPartition)  
...
ComputerSystem_DebugMessage(143, 'm', selectedPartition, partitionsTable[selectedPartition].initAddress, partitionsTable[selectedPartition].size, PID, executableName); 
#line 315 "OperatingSystem.c"
partitionsTable[selectedPartition].PID = PID; 
#line 316 "OperatingSystem.c"
partitionsTable[selectedPartition].occupied = 1; 
...
ComputerSystem_DebugMessage(110, 'p', PID, processTable[PID].nombre, statesNames[processTable[PID].state], statesNames[1]); 
...
ComputerSystem_DebugMessage(110, 'p', PID, processTable[PID].nombre, statesNames[processTable[PID].state], statesNames[2]); 
...
#line 458 "OperatingSystem.c"
char *name = processTable[executingProcessID].nombre;
...
case INVALIDADDRESS: reason = "invalid address"; 
#line 464 "OperatingSystem.c"
break; 
#line 465 "OperatingSystem.c"
case INVALIDPROCESSORMODE: reason = "invalid processor mode"; 
#line 467 "OperatingSystem.c"
break; 
#line 468 "OperatingSystem.c"
case DIVISIONBYZERO: reason = "division by zero"; 
#line 470 "OperatingSystem.c"
break; 
#line 471 "OperatingSystem.c"
case INVALIDINSTRUCTION: reason = "invalid instruction"; 
#line 473 "OperatingSystem.c"
break; } } 
#line 475 "OperatingSystem.c"
ComputerSystem_DebugMessage(140, 'i', executingProcessID, name, reason); 
...
ComputerSystem_DebugMessage(110, 'p', executingProcessID, processTable[executingProcessID].nombre, statesNames[processTable[executingProcessID].state], statesNames[4]); 
#line 489 "OperatingSystem.c"
processTable[executingProcessID].state = EXIT; 
#line 490 "OperatingSystem.c"
OperatingSystem_FreeMainMemory(); 
...
ComputerSystem_DebugMessage(115, 's', executingProcessID, processTable[executingProcessID].nombre, prioritario, processTable[prioritario].nombre); 
...
case SYSCALL_SLEEP: OperatingSystem_SaveContext(executingProcessID); 
...
ComputerSystem_DebugMessage(141, 'i', executingProcessID, processTable[executingProcessID].nombre, systemCallID); 
...
ComputerSystem_DebugMessage(107, 's', "", "", readyToRunQueue[queue][i], processTable[readyToRunQueue[queue][i]].priority, "\n"); } }else{
{ 
#line 610 "OperatingSystem.c"
ComputerSystem_DebugMessage(107, 's', "", "", readyToRunQueue[queue][i], processTable[readyToRunQueue[queue][i]].priority, ","); } }} }else{
{ 
#line 623 "OperatingSystem.c"
if (numberOfReadyToRunProcesses[queue] == 1){
{ 
#line 618 "OperatingSystem.c"
ComputerSystem_DebugMessage(107, 's', queueNames[queue], ":", readyToRunQueue[queue][i], processTable[readyToRunQueue[queue][i]].priority, "\n"); } }else{
{ 
...
ComputerSystem_DebugMessage(120, 'e', numberOfClockInterrupts); 
...
ComputerSystem_DebugMessage(121, 's', copyOfExecutingProcessID, processTable[copyOfExecutingProcessID].nombre, selectedProcess, processTable[selectedProcess].nombre); 
...
if (numberOfReadyToRunProcesses[DAEMONSQUEUE] > 0 && processTable[readyToRunQueue[DAEMONSQUEUE][0]].priority < processTable[executingProcessID].priority){
{ 
...
if (partitionsTable[i].PID == executingProcessID && partitionsTable[i].occupied == 1){
{ 
...
ComputerSystem_DebugMessage(145, 'm', i, partitionsTable[i].initAddress, partitionsTable[i].size, executingProcessID, processTable[executingProcessID].nombre); 
